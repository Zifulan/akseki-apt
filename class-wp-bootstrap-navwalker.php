...
if ( ! class_exists( 'WP_Bootstrap_Navwalker' ) ) {
	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_lvl( &$output, $depth = 0, $args = array() ) {
			...
			$classes = array( 'dropdown-menu', 'bg-dark' );
			/**
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( isset( $args->has_children ) && $args->has_children && $args->depth > 1 ) {
				...
				if(0 === $depth){
					$atts['class']         = 'dropdown-toggle nav-link btn btn-primary text-left';
					$atts['aria-expanded'] = 'false';
				}else{
					$atts['class']         = 'dropdown-toggle dropdown-item text-light';
				...
				if ( $depth > 0 ) {
					$atts['class'] = 'dropdown-item text-light';
				} else {
					$atts['class'] = 'nav-link btn btn-primary text-left';
				}
			}
